...
function validateAndSave(){
	...
	for(var i = 0, j = FIELDS.length; i< j; i++){
		...
		{		
		     Ti.API.info('field: ' + FIELDS[i].id + ', value: ' + FIELDS[i].getText());
		}
		else
		{
